...
const webFiles=['commercial-intelligence.html','commercial-intelligence-core.js','authenticated-intelligence.js','navigation-manifest.js','access-scope.js','historical-data-contract.js','contract-profile.js','product-catalog-contract.js','sales-import-contract.js','sales-fact-model.js','shell-bridge.js'];
...
console.log('Movvant canonical build: existing Web + authenticated intelligence + configurable products + historical sales pipeline -> dist');
