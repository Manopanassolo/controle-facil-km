...
const webFiles=['commercial-intelligence.html','commercial-intelligence-core.js','navigation-manifest.js','shell-bridge.js'];
...
console.log('Movvant canonical build: existing Web + consolidated shell + Intelligence -> dist');
