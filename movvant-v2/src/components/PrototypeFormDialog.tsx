...
type Field = { name:string; label:string; type?:'text'|'number'|'date'|'email'|'tel'|'select'|'multiselect'|'textarea'; placeholder?:string; required?:boolean; options?:FieldOption[]; defaultValue?:string; };
