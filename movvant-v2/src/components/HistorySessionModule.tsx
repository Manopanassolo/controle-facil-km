...
const baseItems=[['01/09 · 10:52','Visita concluída · Casa do MDF','Itajaí → Balneário Camboriú · 14,8 km'],['31/08 · 16:18','Retorno comercial','Camboriú → Itajaí · 18,2 km'],['31/08 · 11:06','Prospecção regional','Itajaí → Navegantes · 22,4 km'],['30/08 · 14:31','Reunião externa','Itajaí → Brusque · 45,7 km']];
