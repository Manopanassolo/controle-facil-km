...
console.log(`Movvant V2 architecture guard passed: ${files.length} source files, one AppShell, ${requiredModules.length} canonical modules, with functional reports/profile/settings, agenda route drafts and accessible prefills protected.`);
