...
if(!html.includes('Gestão de deslocamentos · versão 102.3')) throw new Error('Versão 102.3 ausente');
...
const required=['km_notifications','job_title','single_active_trip_per_user','deleted_at','purpose','usage_type','km_trip_report','<option value="work">Profissional</option>','<option value="ipva">IPVA / impostos</option>'];
...
console.log('KM build validation OK: syntax, IDs and backend contracts passed');
