...
if(!html.includes('Gestão de deslocamentos · versão 103.0')) throw new Error('Versão 103.0 ausente');
...
const required=['km_notifications','job_title','single_active_trip_per_user','deleted_at','purpose','usage_type','km_trip_report','<option value="work">Profissional</option>','<option value="ipva">IPVA / impostos</option>','nav-brand','Painel gerencial','km-menu-open','mobileMenuToggle'];
...
console.log('KM build validation OK: syntax, IDs, backend contracts and corporate visual shell passed');
