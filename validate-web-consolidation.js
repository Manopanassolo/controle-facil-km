...
for(const text of ['Inteligência Comercial','Movvant Enterprise','id="scope"','id="branch"','id="user"','Clientes em risco','Oportunidades prioritárias','Eficiência de campo','Qualidade dos dados','enterprise-intelligence.js']){if(!html.includes(text))throw new Error(`Missing dashboard item: ${text}`)}
...
console.log('Movvant Web Consolidation V1: Enterprise backend + historical sales + risk/opportunity dashboard OK');
