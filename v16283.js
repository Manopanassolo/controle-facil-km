...
(function(){
 ...
 function makeHome(){
   ...
   let home=byId('mvHome88');if(!home){
    home=document.createElement('div');home.id='mvHome88';home.innerHTML=`+
      '<header class="mv-homehead88"><div><h1>Dashboard</h1><p>Visão geral da operação</p></div><button type="button" data-mv88="viagem">＋ Novo percurso</button></header>'+
