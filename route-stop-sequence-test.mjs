...
try{
  ...
  const plan=page.locator('#routePlanBtnV131');await plan.scrollIntoViewIfNeeded();await plan.click();await page.waitForSelector('[data-seq70]');await page.waitForTimeout(300);
