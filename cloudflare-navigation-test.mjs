...
const result={};
const navTo=async name=>{await page.evaluate(n=>{const b=document.querySelector('#app .nav [data-p="'+n+'"]');if(!b)throw new Error('navigation target missing: '+n);b.click()},name);await page.waitForTimeout(140)};
