...
try{
  ...
  result.shell=await page.evaluate(()=>({dockMenu:!!document.querySelector('#mvBottomDock85 [data-mv-dock="menu"]'),dockHome:!!document.querySelector('#mvBottomDock85 [data-mv-dock="inicio"]'),topHidden:document.getElementById('mvTopNavV16282')?getComputedStyle(document.getElementById('mvTopNavV16282')).display==='none':true,api:!!globalThis.mvNavigationV16282?.navigate,historyButton:!!document.querySelector('#app .nav [data-p="historico"]'),agendaButton:!!document.querySelector('#app .nav [data-p="agenda"]')}));
  ...
  await mobileMenu.click();await page.waitForTimeout(80);
  ...
  await page.locator('#mvBottomDock85 [data-mv-dock="inicio"]').click();await page.waitForTimeout(100); result.afterHome=await state();
  ...
  await page.evaluate(()=>globalThis.mvNavigationV16282?.back?.());await page.waitForTimeout(120);
