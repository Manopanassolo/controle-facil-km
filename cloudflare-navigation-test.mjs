...
try{
  ...
  result.pass=Object.values(result.shell).every(Boolean)&&result.initial.authority==='164.1'&&result.history.page==='historico'&&result.history.stored==='historico'&&result.history.visible&&result.menuOpen.menuOpen&&result.agenda.dataset==='agenda'&&!result.agenda.menuOpen&&result.home.page==='inicio'&&result.home.visible&&result.reload.page==='agenda'&&result.reload.stored==='agenda'&&result.reload.visible&&result.reload.authority==='164.1';
